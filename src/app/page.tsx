    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-14 pt-6">
        <div className="rounded-2xl border border-slate-200 p-10">
          ...
          <p className="mt-4 text-lg text-slate-700">
            ...
            basierend auf Temperatur-, Wärmefluss- und Lichtsensorik mit dynamischer Auswertung.
          </p>

          <div className="mt-8 flex flex-wrap gap-3">
            <a className="rounded-lg bg-slate-900 px-5 py-3 text-white" href="/waitlist">
              Warteliste
            </a>
            <a className="rounded-lg border border-slate-300 px-5 py-3" href="#produkt">
              Mehr erfahren
            </a>
          </div>
      ...
      <section id="technik" className="mx-auto max-w-5xl px-6 pb-16">
        ...
        <p className="mt-3 text-slate-700">
          ...
          dessen Parameter aus Messdaten identifiziert werden. Ziel ist Robustheit unter realen,
          transienten Randbedingungen.
        </p>
      </section>

      <footer className="border-t border-slate-200">
        <div className="mx-auto max-w-5xl px-6 py-10 text-sm text-slate-600">
          © {new Date().getFullYear()} U-Check
        </div>
      </footer>
    </main>
  );
